...
OcrReqImage _$OcrReqImageFromJson(Map<String, dynamic> json) {
  return _OcrReqImage.fromJson(json);
}
...
mixin _$OcrReqImage {
  ...
  @JsonKey(ignore: true)
  $OcrReqImageCopyWith<OcrReqImage> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OcrReqImageCopyWith<$Res> {
  factory $OcrReqImageCopyWith(
          OcrReqImage value, $Res Function(OcrReqImage) then) =
      _$OcrReqImageCopyWithImpl<$Res, OcrReqImage>;
  @useResult
  $Res call({String format, String name, String data});
}

/// @nodoc
class _$OcrReqImageCopyWithImpl<$Res, $Val extends OcrReqImage>
    implements $OcrReqImageCopyWith<$Res> {
  _$OcrReqImageCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$OcrReqImageImplCopyWith<$Res>
    implements $OcrReqImageCopyWith<$Res> {
  factory _$$OcrReqImageImplCopyWith(
          _$OcrReqImageImpl value, $Res Function(_$OcrReqImageImpl) then) =
      __$$OcrReqImageImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String format, String name, String data});
}
...
/// @nodoc
class __$$OcrReqImageImplCopyWithImpl<$Res>
    extends _$OcrReqImageCopyWithImpl<$Res, _$OcrReqImageImpl>
    implements _$$OcrReqImageImplCopyWith<$Res> {
  __$$OcrReqImageImplCopyWithImpl(
      _$OcrReqImageImpl _value, $Res Function(_$OcrReqImageImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$OcrReqImageImpl(
      format: null == format
          ? _value.format
          : format // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$OcrReqImageImpl implements _OcrReqImage {
  const _$OcrReqImageImpl(
      {required this.format, required this.name, required this.data});

  factory _$OcrReqImageImpl.fromJson(Map<String, dynamic> json) =>
      _$$OcrReqImageImplFromJson(json);
  ...
  @override
  String toString() {
    return 'OcrReqImage(format: $format, name: $name, data: $data)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OcrReqImageImplCopyWith<_$OcrReqImageImpl> get copyWith =>
      __$$OcrReqImageImplCopyWithImpl<_$OcrReqImageImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OcrReqImageImplToJson(
      this,
    );
  }
}

abstract class _OcrReqImage implements OcrReqImage {
  const factory _OcrReqImage(
      {required final String format,
      required final String name,
      required final String data}) = _$OcrReqImageImpl;

  factory _OcrReqImage.fromJson(Map<String, dynamic> json) =
      _$OcrReqImageImpl.fromJson;
...
mixin _$OcrRequestData {
  ...
  List<OcrReqImage> get images => throw _privateConstructorUsedError;
  @JsonKey(includeIfNull: false)
...
class _$OcrRequestDataImpl implements _OcrRequestData {
  const _$OcrRequestDataImpl(
      ...
      required final List<OcrReqImage> images,
  ...
  @JsonKey(includeIfNull: false)
  final Lang? lang;
  final List<OcrReqImage> _images;
  @override
  List<OcrReqImage> get images {
